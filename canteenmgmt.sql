...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2019 at 05:54 AM
...
CREATE TABLE IF NOT EXISTS `acalacarte` (
...
('17BCE0943', 'Rishav Agarwal', 4525, 'Q', 462, '9878898562'),
('17BCE2015', 'Debajit Datta', 4820, 'Q', 462, '9878898561'),
('17BCE2030', 'Sanchi Chopra', 4625, 'D', 123, '4855521444'),
('17BCE2038', 'Samridhi Murarka', 4425, 'E', 11, '9878898560'),
...
CREATE TABLE IF NOT EXISTS `dalacarte` (
  `iid` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(30) DEFAULT NULL,
  `price` int(11) DEFAULT NULL,
  `time` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dcalacarte` (
  `iid` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(30) DEFAULT NULL,
  `price` int(11) DEFAULT NULL,
  `time` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `eauth` (
...
(17, 2015, '17BCE2038', 'Good Service', 6),
(18, 919, '17BCE2038', 'b vghghv', 10),
(19, 919, '17BCE0943', 'Good Service', 4);
...
CREATE TABLE IF NOT EXISTS `nacalacarte` (
  `iid` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(30) DEFAULT NULL,
  `price` int(11) DEFAULT NULL,
  `time` int(11) NOT NULL,
...
(30, 919, '17BCE2038', '2019-03-20', 130, 'Cancelled', 1),
(31, 919, '17BCE2038', '2019-03-20', 140, 'Completed', 1),
(32, 919, '17BCE2038', '2019-03-21', 240, 'Cancelled', 1),
(33, 919, '17BCE2015', '2019-09-25', 95, 'Received', NULL),
(34, 919, '17BCE2015', '2019-09-25', 55, 'Received', NULL),
(35, 919, '17BCE2038', '2019-10-10', 315, 'Completed', 1),
(36, 943, '17BCE0943', '2019-10-10', 330, 'Received', NULL),
(37, 919, '17BCE0943', '2019-10-10', 65, 'Received', NULL),
(38, 919, '17BCE0943', '2019-10-10', 110, 'Cancelled', 1);
...
CREATE TABLE IF NOT EXISTS `sauth` (
  `custid` varchar(10) DEFAULT NULL,
  `pwd` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `sjtalacarte` (
  `iid` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(30) DEFAULT NULL,
  `price` int(11) DEFAULT NULL,
  `time` int(11) NOT NULL,
